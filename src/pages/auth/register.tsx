...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    else setSuccess('Registration successful! You can now log in.');
  };

  return (
    <>
      <Head>
        <title>Register | Wakanda Chronicles</title>
      </Head>
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-wakanda-gray py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-wakanda-purple">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-wakanda-silver">
                  Name
                </label>
                <div className="mt-1">
                  <input
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 text-center">
                <Link href="/auth/login" className="font-medium text-wakanda-vibranium hover:text-wakanda-purple">
